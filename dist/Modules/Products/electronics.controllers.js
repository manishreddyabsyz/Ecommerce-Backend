...
const ElectronicsServices = __importStar(require("./electronics.services"));
...
const getSlideElectronics = async (req, res) => {
    try {
        let response;
...
//# sourceMappingURL=electronics.controllers.js.map
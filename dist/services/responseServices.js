...
exports.getResponseMessage = exports.sendResponse = exports.setErrorResponse = exports.setSuccessResponse = void 0;
const setSuccessResponse = function (response) {
    if (!response) {
        return response;
    }
...
const setErrorResponse = function (response) {
    ...
    const errorResponse = {
        ...
        message: response.message || (0, exports.getResponseMessage)("SOMETHING_WRONG"),
    };
    if (response.data) {
...
//# sourceMappingURL=responseServices.js.map